...
open class CosmosPublicKey(bytes: ByteArray) : HDSecp256k1PublicKey(bytes) {
...
open class CosmosPrivateKey(bytes: ByteArray) : HDSecp256k1PrivateKey(bytes) {

    override fun createPublicKey(): CosmosPublicKey = CosmosPublicKey(super.createPublicKey().bytes)
