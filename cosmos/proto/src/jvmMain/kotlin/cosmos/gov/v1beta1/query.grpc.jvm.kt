...
public object QueryJvm {
  ...
  public abstract class Server(
    ...
    public open override suspend fun proposal(request: QueryProposalRequest): QueryProposalResponse
        = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Proposal is unimplemented"))

    public open override suspend fun proposals(request: QueryProposalsRequest):
        QueryProposalsResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Proposals is unimplemented"))

    public open override suspend fun vote(request: QueryVoteRequest): QueryVoteResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Vote is unimplemented"))

    public open override suspend fun votes(request: QueryVotesRequest): QueryVotesResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Votes is unimplemented"))

    public open override suspend fun params(request: QueryParamsRequest): QueryParamsResponse =
        throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Params is unimplemented"))

    public open override suspend fun deposit(request: QueryDepositRequest): QueryDepositResponse =
        throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Deposit is unimplemented"))

    public open override suspend fun deposits(request: QueryDepositsRequest): QueryDepositsResponse
        = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.Deposits is unimplemented"))

    public open override suspend fun tallyResult(request: QueryTallyResultRequest):
        QueryTallyResultResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method cosmos.gov.v1beta1.Query.TallyResult is unimplemented"))
