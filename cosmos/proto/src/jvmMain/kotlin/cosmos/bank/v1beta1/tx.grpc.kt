...
public actual object Msg : GrpcService<Msg.Interface, Msg.Server, Msg.Client> {
  ...
  public actual interface Interface {
    ...
    public actual suspend fun multiSend(request: MsgMultiSend): MsgMultiSendResponse

    public actual suspend fun updateParams(request: MsgUpdateParams): MsgUpdateParamsResponse

    public actual suspend fun setSendEnabled(request: MsgSetSendEnabled): MsgSetSendEnabledResponse
  }
