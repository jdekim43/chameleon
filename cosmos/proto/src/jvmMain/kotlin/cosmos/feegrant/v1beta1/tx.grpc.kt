...
public actual object Msg : GrpcService<Msg.Interface, Msg.Server, Msg.Client> {
  ...
  public actual interface Interface {
    public actual suspend fun grantAllowance(request: MsgGrantAllowance): MsgGrantAllowanceResponse

    public actual suspend fun revokeAllowance(request: MsgRevokeAllowance):
