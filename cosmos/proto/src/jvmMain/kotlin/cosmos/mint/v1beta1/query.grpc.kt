...
public actual object Query : GrpcService<Query.Interface, Query.Server, Query.Client> {
  ...
  public actual interface Interface {
    ...
    public actual suspend fun inflation(request: QueryInflationRequest): QueryInflationResponse

    public actual suspend fun annualProvisions(request: QueryAnnualProvisionsRequest):
