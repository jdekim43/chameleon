...
public final class QueryGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest,
      cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse> getParamsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Params",
      requestType = cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest.class,
      responseType = cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest,
      cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse> getParamsMethod() {
    io.grpc.MethodDescriptor<cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest, cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse> getParamsMethod;
    if ((getParamsMethod = QueryGrpc.getParamsMethod) == null) {
      synchronized (QueryGrpc.class) {
        if ((getParamsMethod = QueryGrpc.getParamsMethod) == null) {
          QueryGrpc.getParamsMethod = getParamsMethod =
              io.grpc.MethodDescriptor.<cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest, cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Params"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void params(cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest request,
     ...
     * </pre>
     */
    default void subspaces(cosmos.params.v1beta1.QueryOuterClass.QuerySubspacesRequest request,
  ...
  public static final class QueryFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse> params(
        cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest request) {
  ...
  private static abstract class QueryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cosmos.params.v1beta1.QueryOuterClass.getDescriptor();
    }
