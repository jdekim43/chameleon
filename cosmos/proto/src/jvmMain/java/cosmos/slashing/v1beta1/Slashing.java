...
public final class Slashing {
  ...
  public interface ValidatorSigningInfoOrBuilder extends
     ...
     * </pre>
     *
     * <code>.google.protobuf.Timestamp jailed_until = 4 [(.gogoproto.nullable) = false, (.gogoproto.stdtime) = true, (.amino.dont_omitempty) = true];</code>
  ...
  public interface ParamsOrBuilder extends
    ...
    /**
     * <code>bytes min_signed_per_window = 2 [(.gogoproto.nullable) = false, (.gogoproto.customtype) = "github.com/cosmos/cosmos-sdk/types.Dec", (.amino.dont_omitempty) = true];</code>
     * @return The minSignedPerWindow.
     */
    com.google.protobuf.ByteString getMinSignedPerWindow();

    /**
     * <code>.google.protobuf.Duration downtime_jail_duration = 3 [(.gogoproto.nullable) = false, (.gogoproto.stdduration) = true, (.amino.dont_omitempty) = true];</code>
    ...
    /**
     * <code>bytes slash_fraction_double_sign = 4 [(.gogoproto.nullable) = false, (.gogoproto.customtype) = "github.com/cosmos/cosmos-sdk/types.Dec", (.amino.dont_omitempty) = true];</code>
     * @return The slashFractionDoubleSign.
     */
    com.google.protobuf.ByteString getSlashFractionDoubleSign();

    /**
     * <code>bytes slash_fraction_downtime = 5 [(.gogoproto.nullable) = false, (.gogoproto.customtype) = "github.com/cosmos/cosmos-sdk/types.Dec", (.amino.dont_omitempty) = true];</code>
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_proto/cosmos.proto\032\021amino/amino.proto\"\353" +
      "\001\n\024ValidatorSigningInfo\022)\n\007address\030\001 \001(\t" +
      "B\030\322\264-\024cosmos.AddressString\022\024\n\014start_heig" +
      "ht\030\002 \001(\003\022\024\n\014index_offset\030\003 \001(\003\022?\n\014jailed" +
      "_until\030\004 \001(\0132\032.google.protobuf.Timestamp" +
      "B\r\310\336\037\000\220\337\037\001\250\347\260*\001\022\022\n\ntombstoned\030\005 \001(\010\022\035\n\025m" +
      "issed_blocks_counter\030\006 \001(\003:\010\230\240\037\000\350\240\037\001\"\226\003\n" +
      "\006Params\022\034\n\024signed_blocks_window\030\001 \001(\003\022R\n" +
      "\025min_signed_per_window\030\002 \001(\014B3\310\336\037\000\332\336\037&gi" +
      "thub.com/cosmos/cosmos-sdk/types.Dec\250\347\260*" +
      "\001\022H\n\026downtime_jail_duration\030\003 \001(\0132\031.goog" +
      "le.protobuf.DurationB\r\310\336\037\000\230\337\037\001\250\347\260*\001\022W\n\032s" +
      "lash_fraction_double_sign\030\004 \001(\014B3\310\336\037\000\332\336\037" +
      "&github.com/cosmos/cosmos-sdk/types.Dec\250" +
      "\347\260*\001\022T\n\027slash_fraction_downtime\030\005 \001(\014B3\310" +
      "\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/type" +
      "s.Dec\250\347\260*\001:!\212\347\260*\034cosmos-sdk/x/slashing/P" +
      "aramsB3Z-github.com/cosmos/cosmos-sdk/x/" +
