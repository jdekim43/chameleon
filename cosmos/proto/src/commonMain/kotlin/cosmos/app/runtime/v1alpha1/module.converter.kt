...
public expect object StoreKeyConfigConverter : ProtobufConverter<StoreKeyConfig>

public fun StoreKeyConfig.toAny(): Any = Any(StoreKeyConfig.TYPE_URL, with(StoreKeyConfigConverter)
    { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<StoreKeyConfig>): StoreKeyConfig {
  if (typeUrl != StoreKeyConfig.TYPE_URL) throw IllegalStateException("Please check the type_url")
  return value.parseProtobuf(converter)
}
