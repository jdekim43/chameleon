...
public fun MsgExecLegacyContent.toAny(): Any = Any(MsgExecLegacyContent.TYPE_URL,
    with(MsgExecLegacyContentConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<MsgExecLegacyContent>): MsgExecLegacyContent {
  if (typeUrl != MsgExecLegacyContent.TYPE_URL) throw
      IllegalStateException("Please check the type_url")
  return value.parseProtobuf(converter)
}
...
public fun MsgExecLegacyContentResponse.toAny(): Any = Any(MsgExecLegacyContentResponse.TYPE_URL,
    with(MsgExecLegacyContentResponseConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<MsgExecLegacyContentResponse>):
    MsgExecLegacyContentResponse {
  if (typeUrl != MsgExecLegacyContentResponse.TYPE_URL) throw
      IllegalStateException("Please check the type_url")
  return value.parseProtobuf(converter)
}
