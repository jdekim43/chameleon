...
fun resolveCosmosSdkVersion(): String {
    val directory = File(projectDir, "dependencies/cosmos-sdk")
...
version = project.version.toString() + "-" + resolveCosmosSdkVersion()
...
dependencies {
    ...
    protobuf(files("dependencies/google"))
    protobuf(files("dependencies/gogoproto"))
    protobuf(files("dependencies/cosmos-proto/proto"))
    protobuf(files("dependencies/cosmos-sdk/proto"))
}
