...
open class InitiaCosmosPublicKey(bytes: ByteArray) : HDSecp256k1PublicKey(bytes) {
...
open class InitiaCosmosPrivateKey(bytes: ByteArray) : HDSecp256k1PrivateKey(bytes) {
