...
fun resolveWasmdVersion(): String {
    val directory = File(projectDir, "dependencies/wasmd")
    ...
    return input.use { it.readLine() }.removePrefix("v")
        .also { println("Resolved wasmd version : $it") }
}

version = project.version.toString() + "-" + resolveWasmdVersion()
...
dependencies {
    ...
    protobuf(files("dependencies/wasmd/proto"))
