...
open class EthereumSecp256k1PublicKey(private val hdPublicKey: HDSecp256k1PublicKey) : PublicKey {
...
open class EthereumSecp256k1PrivateKey(
    private val hdPrivateKey: HDSecp256k1PrivateKey,
    hdPublicKey: HDSecp256k1PublicKey? = null,
) : KeyPair,
    PrivateKey,
    EthereumSecp256k1PublicKey(hdPublicKey ?: hdPrivateKey.createPublicKey()) {
