...
public data class Params(
  ...
  public val basePool: ByteArray,
  @ProtobufIndex(index = 2)
  public val poolRecoveryPeriod: ULong,
  @ProtobufIndex(index = 3)
  public val minStabilitySpread: ByteArray,
) : ProtobufMessage {
  public companion object {
    public const val TYPE_URL: String = "/terra.market.v1beta1.Params"
  }
