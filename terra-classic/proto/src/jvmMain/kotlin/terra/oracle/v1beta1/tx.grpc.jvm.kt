...
public object MsgJvm {
  ...
  private val aggregateExchangeRatePrevoteDescriptor:
  ...
  public abstract class Server(
    ...
    public open override suspend
        fun aggregateExchangeRatePrevote(request: MsgAggregateExchangeRatePrevote):
        MsgAggregateExchangeRatePrevoteResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method terra.oracle.v1beta1.Msg.AggregateExchangeRatePrevote is unimplemented"))

    public open override suspend
        fun aggregateExchangeRateVote(request: MsgAggregateExchangeRateVote):
        MsgAggregateExchangeRateVoteResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method terra.oracle.v1beta1.Msg.AggregateExchangeRateVote is unimplemented"))

    public open override suspend fun delegateFeedConsent(request: MsgDelegateFeedConsent):
        MsgDelegateFeedConsentResponse = throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method terra.oracle.v1beta1.Msg.DelegateFeedConsent is unimplemented"))
        ...
        ServerServiceDefinition.builder(descriptor)
    		.addMethod(
    			ServerCalls.unaryServerMethodDefinition(
    				...
    				descriptor = aggregateExchangeRatePrevoteDescriptor,
    				implementation = {
        MsgAggregateExchangeRatePrevoteResponseJvmConverter.convert(aggregateExchangeRatePrevote(MsgAggregateExchangeRatePrevoteJvmConverter.convert(it)))
        },
    			)
    		)
    		.addMethod(
  ...
  public open class Client(
    ...
    public override suspend
        fun aggregateExchangeRatePrevote(request: MsgAggregateExchangeRatePrevote):
        MsgAggregateExchangeRatePrevoteResponse = aggregateExchangeRatePrevote(request, Metadata())

    public suspend fun aggregateExchangeRatePrevote(request: MsgAggregateExchangeRatePrevote,
        metadata: Metadata): MsgAggregateExchangeRatePrevoteResponse =
        MsgAggregateExchangeRatePrevoteResponseJvmConverter.convert(
    		ClientCalls.unaryRpc(
    			option.channel, aggregateExchangeRatePrevoteDescriptor,
    			MsgAggregateExchangeRatePrevoteJvmConverter.convert(request),
