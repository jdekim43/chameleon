...
fun resolveTerraClassicVersion(): String {
    val directory = File(projectDir, "dependencies/classic-core")
    ...
    return input.use { it.readLine() }.removePrefix("v")
        .also { println("Resolved terra-classic version : $it") }
}

version = project.version.toString() + "-" + resolveTerraClassicVersion()
...
dependencies {
    ...
    protobuf(files("dependencies/classic-core/proto"))
