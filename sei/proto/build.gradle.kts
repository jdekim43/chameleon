...
fun resolveSeiVersion(): String {
    val directory = File(projectDir, "dependencies/sei-chain")
    ...
    return input.use { it.readLine() }.removePrefix("v")
        .also { println("Resolved sei version : $it") }
}

version = project.version.toString() + "-" + resolveSeiVersion()
...
dependencies {
    ...
    protobuf(files("dependencies/sei-chain/proto"))
