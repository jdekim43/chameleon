...
public object QueryJvm {
  ...
  private val minterDescriptor:
      MethodDescriptor<QueryOuterClass.QueryMinterRequest, QueryOuterClass.QueryMinterResponse> =
      QueryGrpc.getMinterMethod()!!
  ...
  public abstract class Server(
    ...
    public open override suspend fun params(request: QueryParamsRequest): QueryParamsResponse =
        throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method seiprotocol.seichain.mint.Query.Params is unimplemented"))

    public open override suspend fun minter(request: QueryMinterRequest): QueryMinterResponse =
        throw
        StatusException(Status.UNIMPLEMENTED.withDescription("Method seiprotocol.seichain.mint.Query.Minter is unimplemented"))
    ...
    public override fun bindService(): ServerServiceDefinition =
        ...
        QueryParamsResponseJvmConverter.convert(params(QueryParamsRequestJvmConverter.convert(it)))
    		...
    		.addMethod(
    			ServerCalls.unaryServerMethodDefinition(
    				context = this.context,
    				descriptor = minterDescriptor,
    				implementation = {
        QueryMinterResponseJvmConverter.convert(minter(QueryMinterRequestJvmConverter.convert(it)))
        },
    			)
    		)
    		.build()
  ...
  public open class Client(
    ...
    public override suspend fun minter(request: QueryMinterRequest): QueryMinterResponse =
        minter(request, Metadata())

    public suspend fun minter(request: QueryMinterRequest, metadata: Metadata): QueryMinterResponse
        = QueryMinterResponseJvmConverter.convert(
    		ClientCalls.unaryRpc(
    			option.channel, minterDescriptor,
    			QueryMinterRequestJvmConverter.convert(request),
    			option.callOptions, metadata,
    		),
    	)
  }
