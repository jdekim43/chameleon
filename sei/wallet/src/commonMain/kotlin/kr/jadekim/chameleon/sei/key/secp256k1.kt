...
open class SeiSecp256k1PublicKey(override val hdPublicKey: HDPublicKey) : HDSecp256k1PublicKey {

    constructor(publicKey: ByteArray) : this(HDPublicKey(publicKey))
}

open class SeiSecp256k1PrivateKey(
    override val hdPrivateKey: HDPrivateKey,
    hdPublicKey: HDPublicKey? = null,
) : KeyPair,
    HDSecp256k1PrivateKey,
    SeiSecp256k1PublicKey(hdPublicKey ?: hdPrivateKey.createPublicKey()) {
